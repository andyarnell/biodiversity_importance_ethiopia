...
DROP TABLE IF EXISTS out_sppimp_eth_10km_2013_anmls;
CREATE TABLE out_sppimp_eth_10km_2013_anmls AS 
...
DROP TABLE IF EXISTS out_cell_imp_eth_10km_2013_anmls;
CREATE TABLE out_cell_imp_eth_10km_2013_anmls AS
SELECT o.cell_id, SUM(o.sppimp_eq) AS cellimp_eq, SUM(o.sppimp_max) AS cellimp_max, SUM(o.sppimp_min) AS cellimp_min 
FROM out_sppimp_eth_10km_2013_anmls as o
GROUP BY o.cell_id;


--join final results to watershed polygons for viewing
DROP TABLE IF EXISTS out_cell_imp_shape_eth_10km_2013_anmls;
CREATE TABLE out_cell_imp_shape_eth_10km_2013_anmls AS 
SELECT o.*, p.the_geom as the_geom  
FROM 
out_cell_imp_eth_10km_2013_anmls AS o,
cells_eth_10km AS p 
WHERE o.cell_id=p.cell_id;

--convert to wgs84 for viewing purposes
ALTER TABLE out_cell_imp_shape_eth_10km_2013_anmls
...
FROM (select *, 1 as num from out_sppimp_eth_10km_2013_anmls) as o
GROUP BY o.num;
